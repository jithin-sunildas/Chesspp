...
class Pawn {
public:
    Pawn(Color clr, int row, int col, int index)
        : side(clr) {
        pawn.x = row;
        pawn.y = col;
        pawn.index = index;
...
class Knight {
public:
    Knight(Color clr, int row, int col, int index)
        : side(clr) {
        knight.x = row;
        knight.y = col;
        knight.index = index;
...
class Rook {
public:
    Rook(Color clr, int row, int col, int index)
        : side(clr) {
        rook.x = row;
        rook.y = col;
        rook.index = index;
...
class Bishop {
public:
    Bishop(Color clr, int row, int col, int index)
        : side(clr) {
        bishop.x = row;
        bishop.y = col;
        bishop.index = index;
